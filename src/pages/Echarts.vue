<template>
  <div ref="divCharts" class="full-width" style="height: 100vh"></div>
</template>

<script setup>

import * as echarts from 'echarts';
import china from 'src/assets/china.json';
...
function initCharts() {
  ...
  const charts = echarts.init(divCharts.value);
  const option = {
    ...
    series: [
      ...
      { // 线条系列数据
        ...
        effect: { // 线条特效的配置
          ...
          trailLength: 0.02, // 特效尾迹的长度。取值[0,1]值越大，尾迹越重
          symbol: 'arrow', // 特效图形的标记 可选'circle'等
